...
{
    public class FileViewQueryBuilder:ITopicQueryBuilder
    {
        // TopicQuery _topicQuery;
        TopicViewQuery _topicQuery;

        public FileViewQueryBuilder(TopicViewQuery topicQuery)
        {
        ...
        {
            _topicQuery.SetViewTopic(TopicMainTable.CompanyFiles, TopicCategoryAccessTable.CategoryAccess);

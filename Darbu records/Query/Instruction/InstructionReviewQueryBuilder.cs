...
{
    public class InstructionReviewQueryBuilder:ITopicQueryBuilder
    {

        // TopicQuery _topicQuery;
        TopicReviewQuery _topicQuery;

        public InstructionReviewQueryBuilder(TopicReviewQuery topicQuery)
        {
        ...
        {
            _topicQuery.SetReviewTopic(TopicMainTable.Instruction, TopicFileTable.InstructionFiles, TopicImageTable.InstructionPhotos, TopicCategoryAccessTable.CategoryAccess);
